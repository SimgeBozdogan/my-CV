    ...
    <div className="cv-container">
      <div className="left-column">
        ...
        <section className="contact">
          <h3>Contact</h3>
          <p>I am a software developer who enjoys and is curious about Full-Stack Development. I feel ready and excited for new and developing experiences by using the knowledge I've gained from education and experience. I am aware of the value I can add to a company and continue to improve myself to increase this value.</p>
